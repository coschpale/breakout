    ...
    for brick in bricks:
        if brick.alive:
            ...
            if ball.pos_y - ball.radius == brick.pos_y and ball.pos_x + ball.radius >= brick.pos_x and ball.pos_x - ball.radius <= brick.pos_x + brick.width:
                ...
                ball.bounce(x_bounce=True, y_bounce=False)
            # right
            if ball.pos_x - ball.radius == brick.pos_x + brick.width and ball.pos_y + ball.radius >= brick.pos_y and ball.pos_y - ball.radius <= brick.pos_y + brick.height:
                brick.kill()
                ball.bounce(x_bounce=False, y_bounce=True)
            # left
            if ball.pos_x + ball.radius == brick.pos_x and ball.pos_y + ball.radius >= brick.pos_y and ball.pos_y - ball.radius <= brick.pos_y + brick.height:
                brick.kill()
                ball.bounce(x_bounce=False, y_bounce=True)
